...
export const courses: Course[] = [
  {
    ...
    lessons: [
      ...
      { title: "Bài 2: Sai lầm về phát triển quân", youtubeId: "223hheie0P0", duration: "06:40", free: true },
  ...
  },
  {
    ...
    lessons: [
      ...
      { title: "Bài 2: Tàn Xe cơ bản", youtubeId: "223hheie0P0", duration: "06:15", free: true },
